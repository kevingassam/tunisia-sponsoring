...
<html lang="en-US" dir="ltr">
  ...
  <head>
    ...
    <link href="/front/assets/css/theme.css" rel="stylesheet" />
      ...
      <!-- Meta Description -->
      <meta name="description" content="TUnisia Sponsoring TN permet la sponsorisation de vos pages et contenus sur diverses plateformes sans carte en Tunisie. Nous gérons les paiements pour vous.">

      <!-- Keywords -->
      <meta name="keywords" content="TUnisia Sponsoring TN, sponsorisation, Tunisie, paiement sans carte, Facebook, Instagram, Google Ads, publicité en ligne, marketing digital">
  
      <!-- Open Graph Meta Tags for Social Media Sharing -->
      <meta property="og:title" content="TUnisia Sponsoring TN - Sponsorisation des Pages en Tunisie">
      <meta property="og:description" content="TUnisia Sponsoring TN permet la sponsorisation de vos pages et contenus sur diverses plateformes sans carte en Tunisie. Nous gérons les paiements pour vous.">
      ...
      <meta name="twitter:description" content="TUnisia Sponsoring TN permet la sponsorisation de vos pages et contenus sur diverses plateformes sans carte en Tunisie. Nous gérons les paiements pour vous.">
  ...
  <body>
    ...
    <main class="main" id="top">
          ...
          <div class="row align-items-center">
            ...
            <div class="col-md-7 col-lg-6 text-md-start text-center py-6">
              ...
              <p class="mb-4 fw-medium">
                TUnisia Sponsoring TN permet la sponsorisation de vos pages et contenus sur diverses plateformes sans carte en Tunisie. Nous gérons les paiements pour vous.
              </p>
      ...
      <section class="pt-5 pt-md-9" id="service">
        ...
        <div class="container">
          <div class="position-absolute z-index--1 end-0 d-none d-lg-block"><img src="/front/assets/img/category/shape.svg" style="max-width: 200px" alt="service" /></div>
          ...
          <div class="row">
            <div class="col-lg-3 col-sm-6 mb-6">
              <div class="card service-card shadow-hover rounded-3 text-center align-items-center">
                <div class="card-body p-xxl-5 p-4"> <img src="/front/assets/img/category/icon1.png" width="75" alt="Service" />
            ...
            <div class="col-lg-3 col-sm-6 mb-6">
              <div class="card service-card shadow-hover rounded-3 text-center align-items-center">
                <div class="card-body p-xxl-5 p-4"> <img src="/front/assets/img/category/icon2.png" width="75" alt="Service" />
            ...
            <div class="col-lg-3 col-sm-6 mb-6">
              <div class="card service-card shadow-hover rounded-3 text-center align-items-center">
                <div class="card-body p-xxl-5 p-4"> <img src="/front/assets/img/category/icon3.png" width="75" alt="Service" />
            ...
            <div class="col-lg-3 col-sm-6 mb-6">
              <div class="card service-card shadow-hover rounded-3 text-center align-items-center">
                <div class="card-body p-xxl-5 p-4"> <img src="/front/assets/img/category/icon4.png" width="75" alt="Service" />
      ...
      <section class="pt-5" id="destination">
        ...
        <div class="container">
          <div class="position-absolute start-100 bottom-0 translate-middle-x d-none d-xl-block ms-xl-n4"><img src="/front/assets/img/dest/shape.svg" alt="destination" /></div>
          <div class="mb-7 text-center">
          ...
          <div class="row">
            <div class="col-md-4 mb-4">
              <div class="card overflow-hidden shadow"> <img class="card-img-top" src="/front/assets/img/dest/dest1.jpg" alt="Rome, Italty" />
                <div class="card-body py-4 px-3">
                  ...
                  <div class="d-flex align-items-center"> <img src="/front/assets/img/dest/navigation.svg" style="margin-right: 14px" width="20" alt="navigation" /><span class="fs-0 fw-medium">10 Days Trip</span></div>
                </div>
              </div>
            </div>
            <div class="col-md-4 mb-4">
              <div class="card overflow-hidden shadow"> <img class="card-img-top" src="/front/assets/img/dest/dest2.jpg" alt="London, UK" />
                <div class="card-body py-4 px-3">
                  <div class="d-flex flex-column flex-lg-row justify-content-between mb-3">
                  ...
                  <div class="d-flex align-items-center"> <img src="/front/assets/img/dest/navigation.svg" style="margin-right: 14px" width="20" alt="navigation" /><span class="fs-0 fw-medium">12 Days Trip</span></div>
                </div>
              </div>
            </div>
            <div class="col-md-4 mb-4">
              <div class="card overflow-hidden shadow"> <img class="card-img-top" src="/front/assets/img/dest/dest3.jpg" alt="Full Europe" />
                <div class="card-body py-4 px-3">
                  <div class="d-flex flex-column flex-lg-row justify-content-between mb-3">
                  ...
                  <div class="d-flex align-items-center"> <img src="/front/assets/img/dest/navigation.svg" style="margin-right: 14px" width="20" alt="navigation" /><span class="fs-0 fw-medium">28 Days Trip</span></div>
                </div>
              </div>
            </div>
          </div>
          ...
          <div class="row align-items-center">
            <div class="col-lg-6">
              ...
              <div class="d-flex align-items-start mb-5">
                <div class="bg-primary me-sm-4 me-3 p-3" style="border-radius: 13px"> <img src="/front/assets/img/steps/selection.svg" width="22" alt="steps" /></div>
                <div class="flex-1">
              ...
              <div class="d-flex align-items-start mb-5">
                <div class="bg-danger me-sm-4 me-3 p-3" style="border-radius: 13px"> <img src="/front/assets/img/steps/water-sport.svg" width="22" alt="steps" /></div>
                <div class="flex-1">
              ...
              <div class="d-flex align-items-start mb-5">
                <div class="bg-info me-sm-4 me-3 p-3" style="border-radius: 13px"> <img src="/front/assets/img/steps/taxi.svg" width="22" alt="steps" /></div>
                <div class="flex-1">
            ...
            <div class="col-lg-6 d-flex justify-content-center align-items-start">
              <div class="card position-relative shadow" style="max-width: 370px;">
                <div class="position-absolute z-index--1 me-10 me-xxl-0" style="right:-160px;top:-210px;"> <img src="/front/assets/img/steps/bg.png" style="max-width:550px;" alt="shape" /></div>
                <div class="card-body p-3"> <img class="mb-4 mt-2 rounded-2 w-100" src="/front/assets/img/steps/booking-img.jpg" alt="booking" />
                  <div>
                    <h5 class="fw-medium">Trip To Greece</h5>
                    <p class="fs--1 mb-3 fw-medium">14-29 June | by Robbin joseph</p>
                    <div class="icon-group mb-4"> <span class="btn icon-item"> <img src="/front/assets/img/steps/leaf.svg" alt=""/></span><span class="btn icon-item"> <img src="/front/assets/img/steps/map.svg" alt=""/></span><span class="btn icon-item"> <img src="/front/assets/img/steps/send.svg" alt=""/></span>
                    </div>
                    <div class="d-flex align-items-center justify-content-between">
                      <div class="d-flex align-items-center mt-n1"><img class="me-3" src="/front/assets/img/steps/building.svg" width="18" alt="building" /><span class="fs--1 fw-medium">24 people going</span></div>
                      <div class="show-onhover position-relative">
                        <div class="card hideEl shadow position-absolute end-0 start-xl-50 bottom-100 translate-xl-middle-x ms-3" style="width: 260px;border-radius:18px;">
                          <div class="card-body py-3">
                            <div class="d-flex">
                              <div style="margin-right: 10px"> <img class="rounded-circle" src="/front/assets/img/steps/favorite-placeholder.png" width="50" alt="favorite" /></div>
                              <div>
                        ...
                        <button class="btn"> <img src="/front/assets/img/steps/heart.svg" width="20" alt="step" /></button>
                      </div>
                    </div>
                  </div>
                </div>
              ...
              <div class="pe-7 ps-5 ps-lg-0">
                <div class="carousel slide carousel-fade position-static" id="testimonialIndicator" data-bs-ride="carousel">
                  ...
                  <div class="carousel-inner">
                    <div class="carousel-item position-relative active">
                      <div class="card shadow" style="border-radius:10px;">
                        <div class="position-absolute start-0 top-0 translate-middle"> <img class="rounded-circle fit-cover" src="/front/assets/img/testimonial/author.png" height="65" width="65" alt="" /></div>
                    ...
                    <div class="carousel-item position-relative ">
                      <div class="card shadow" style="border-radius:10px;">
                        <div class="position-absolute start-0 top-0 translate-middle"> <img class="rounded-circle fit-cover" src="/front/assets/img/testimonial/author2.png" height="65" width="65" alt="" /></div>
                        <div class="card-body p-4">
                    ...
                    <div class="carousel-item position-relative ">
                      <div class="card shadow" style="border-radius:10px;">
                        <div class="position-absolute start-0 top-0 translate-middle"> <img class="rounded-circle fit-cover" src="/front/assets/img/testimonial/author3.png" height="65" width="65" alt="" /></div>
                        <div class="card-body p-4">
                          <p class="fw-medium mb-4">&quot;On the Windows talking painted pasture yet its express parties use. Sure last upon he same as knew next. Of believed or diverted no.&quot;</p>
                  ...
                  <div class="carousel-navigation d-flex flex-column flex-between-center position-absolute end-0 top-lg-50 bottom-0 translate-middle-y z-index-1 me-3 me-lg-0" style="height:60px;width:20px;">
                    <button class="carousel-control-prev position-static" type="button" data-bs-target="#testimonialIndicator" data-bs-slide="prev"><img src="/front/assets/img/icons/up.svg" width="16" alt="icon" /></button>
                    <button class="carousel-control-next position-static" type="button" data-bs-target="#testimonialIndicator" data-bs-slide="next"><img src="/front/assets/img/icons/down.svg" width="16" alt="icon" /></button>
                  </div>
                </div>
              </div>
            </div>
          ...
          <div class="row row-cols-lg-5 row-cols-md-3 row-cols-2 flex-center">
            <div class="col">
              <div class="card shadow-hover mb-4" style="border-radius:10px;">
                <div class="card-body text-center"> <img class="img-fluid" src="/front/assets/img/partner/1.png" alt="" /></div>
              </div>
            </div>
            <div class="col">
              <div class="card shadow-hover mb-4" style="border-radius:10px;">
                <div class="card-body text-center"> <img class="img-fluid" src="/front/assets/img/partner/2.png" alt="" /></div>
              </div>
            </div>
            <div class="col">
              <div class="card shadow-hover mb-4" style="border-radius:10px;">
                <div class="card-body text-center"> <img class="img-fluid" src="/front/assets/img/partner/3.png" alt="" /></div>
              </div>
            </div>
            <div class="col">
              <div class="card shadow-hover mb-4" style="border-radius:10px;">
                <div class="card-body text-center"> <img class="img-fluid" src="/front/assets/img/partner/4.png" alt="" /></div>
              </div>
            </div>
            <div class="col">
              <div class="card shadow-hover mb-4" style="border-radius:10px;">
                <div class="card-body text-center"> <img class="img-fluid" src="/front/assets/img/partner/5.png" alt="" /></div>
              </div>
            </div>
          </div>
        </div>
          ...
          <div class="row">
            ...
            <div class="col-lg-3 col-md-5 col-12 mb-4 mb-md-6 mb-lg-0 order-lg-4 order-md-1">
              ...
              <div class="icon-group mb-4"> 
                <a class="text-decoration-none icon-item shadow-social" id="facebook" href="#!"><i class="fab fa-facebook-f"> </i></a><a class="text-decoration-none icon-item shadow-social" id="instagram" href="#!"><i class="fab fa-instagram"> </i></a><a class="text-decoration-none icon-item shadow-social" id="twitter" href="#!"><i class="fab fa-twitter"> </i></a></div>
